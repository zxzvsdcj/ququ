            ...
            <div className="p-6">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  />
                  <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
                    支持的修饰键：CommandOrControl (Ctrl/Cmd)、Shift、Alt、Space、F1-F12
                  </p>
                </div>
                      ...
                      try {
                        ...
                        if (window.electronAPI) {
                          ...
                          if (window.electronAPI.registerHotkey) {
                            try {
                              await window.electronAPI.registerHotkey(settings.hotkey);
                              toast.success("快捷键已保存并生效");
                            } catch (error) {
                              console.error("快捷键注册失败:", error);
                              toast.success("快捷键已保存，但注册失败");
                            }
                          } else {
